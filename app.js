...
const roadmapCivilian = [
    ...
    { title: "ВЛК за направленням", text: "Направлення на ВЛК прийде Новою поштою разом з контрактами.", faq: "faq-vlk-1", link: { href: "https://drive.google.com/file/d/1fpKGmA_ftcMRENMNiIEcolr5iVj8Au7a/view?usp=drive_link", text: "зразок заповнення контракту" } },
    { title: "Контракти та повний пакет документів", text: "Заповніть 2 примірники контракту (<a href=\"https://drive.google.com/file/d/1fpKGmA_ftcMRENMNiIEcolr5iVj8Au7a/view?usp=drive_link\" class=\"step-link\" target=\"_blank\" rel=\"noopener\">зразок</a>) й надішліть <a href=\"#checklist-title\" class=\"step-link\">повний перелік документів</a>.", faq: "faq-docs-civilian" },
...
const roadmapMilitary = [
    ...
    { title: "Заява, військовий квиток, диплом", text: "Власноруч напишіть заяву на ім'я голови відбіркової комісії, сфотографуйте військовий квиток і диплом (або довідку з університету, що ви студент).", link: { href: "https://drive.google.com/file/d/15nOhUpsjAf81dUS7xF75c2ZgN5Jlo5-z/view?usp=sharing", text: "зразок заяви" } },
    { title: "Вставте всі фото в один файл .docx", text: "Назва файлу: ПІБ_дата_народження.docx (наприклад, Коваленко_Степан_Петрович_12051985.docx)." },
    { title: "Реєстрація на сайті вступу", text: "Оберіть ВОС і прикріпіть створений файл.", link: { href: "https://sites.google.com/view/kvpzvi/", text: "сайт вступу" } },
    { title: "Психологічне тестування", text: "Три методики онлайн." },
    { title: "Контракт Новою поштою", text: "Отримайте 2 примірники контракту, заповніть і надішліть разом із заявою та копіями документів.", link: { href: "https://drive.google.com/file/d/1fpKGmA_ftcMRENMNiIEcolr5iVj8Au7a/view?usp=drive_link", text: "зразок заповнення контракта" } },
...
const roadmapCommon = [
    ...
    { title: "Надсилання документів", text: "Контракт та інші документи - на відділення Нової пошти №10 у Житомирі.", link: { href: "https://drive.google.com/file/d/1fpKGmA_ftcMRENMNiIEcolr5iVj8Au7a/view?usp=drive_link", text: "зразок заповнення контракту" } },
...
const checklistCivilian = [
    ...
    { id: "doc-vlk-orig", text: "Довідка ВЛК (оригінал, з висновком «Придатний до військової служби» або «Придатний до служби у військових частинах забезпечення, ТЦК та СП, ВНЗ, установах, організаціях, навчальних центрах») - <strong>1 шт.</strong>" },
    { id: "doc-vlk-copy", text: "Копія довідки ВЛК - <strong>1 шт.</strong>" },
    { id: "doc-contract", text: "Контракт про навчання на військовій кафедрі (<a href=\"https://drive.google.com/file/d/1fpKGmA_ftcMRENMNiIEcolr5iVj8Au7a/view?usp=drive_link\" target=\"_blank\" rel=\"noopener\">зразок заповнення</a>) - <strong>2 шт.</strong>" },
...
const checklistMilitary = [
    ...
    { id: "mil-doc-diploma", text: "Фото диплома про вищу освіту або довідки з університету, що ви студент (якщо ще навчаєтесь) - <strong>1 шт.</strong>" },
    { id: "mil-doc-contract", text: "Контракт про навчання на військовій кафедрі (надійде Новою поштою, заповнити за <a href=\"https://drive.google.com/file/d/1fpKGmA_ftcMRENMNiIEcolr5iVj8Au7a/view?usp=drive_link\" target=\"_blank\" rel=\"noopener\">зразком</a>) - <strong>2 прим.</strong>" }
];
...
const faqData = [
    ...
    },
    {
        ...
        category: "general",
        audience: "all",
        question: "Хто саме має право вступати на кафедру військової підготовки (з 4-х місячним терміном підготовки)?",
    ...
    },
    {
        ...
        <ol>
            ...
            <li>Зробити <strong>фото диплома</strong> про вищу освіту або <strong>довідки з університету</strong> що Ви є студентом, якщо ви ще навчаєтесь (бакалавр або вище);</li>
    ...
    },
    {
        ...
        <p>Дистанційна частина відбувається у зручному для вас режимі: конкретний час не встановлюється, є лише дедлайни звітності.</p>
        <p>На навчальний збір вас відряджає командир вашої частини своїм наказом за нашим поданням.</p>`
    },
    {
        ...
        <p>Служба після закінчення кафедри <strong>не є обов'язковою</strong>: можна за бажанням піти на контрактну службу на офіцерській посаді в ЗСУ, СБУ, Нацгвардію, ДПСУ, Національну поліцію (у будь-яке силове відомство України) або працювати на цивільних посадах. Якщо на момент присвоєння звання діє відстрочка або бронювання, вони продовжують діяти.</p>`
    },
    {
        id: "faq-10",
        category: "payment",
    ...
    },
    {
        ...
        answer: `<p>Набір триває, подання документів і тестування здійснюються онлайн. Завершення прийому документів - <strong>20 серпня</strong>. Початок навчання - <strong>1 вересня</strong>.</p>
    ...
    },
    {
        ...
        <p><strong>Загальні вимоги до копій:</strong> формат <strong>А4</strong>, <strong>портретна</strong> орієнтація, друк з одного боку. Поля: <strong>ліве - 30 мм</strong>, верхнє і нижнє - 15 мм, праве - 10 мм або більше. Документи розташовуються <strong>вертикально</strong>. Сам документ на копії повинен бути рівним (не зігнутим). Фон навкруги документа має бути білим. Не розташовуйте декілька різних документів на одному аркуші. Усі записи мають бути читабельними.</p>
        <ol>
            ...
            <li>Довідка ВЛК (оригінал, з висновком «Придатний до військової служби» або «Придатний до служби у військових частинах забезпечення, ТЦК та СП, ВНЗ, установах, організаціях, навчальних центрах») - <strong>1 примірник</strong>;</li>
            <li>Копія довідки ВЛК - <strong>1 примірник</strong>;</li>
            <li>Контракт про навчання (<a href="https://drive.google.com/file/d/1fpKGmA_ftcMRENMNiIEcolr5iVj8Au7a/view?usp=drive_link" target="_blank" rel="noopener">зразок заповнення</a>) - <strong>2 примірники</strong>;</li>
    ...
    },
    {
        ...
        <p>Але, звичайно, викладачі за профілями підготовки завжди готові враховувати об'єктивні життєві і воєнні проблеми, коригувати графіки звітності у межах суворої відповідності програмі підготовки.</p>
    ...
    },
    {
        ...
        answer: `<p>Бланк контракту буде надіслано Вам Новою поштою разом із направленням на ВЛК. Контракт заповнюється у <strong>двох примірниках</strong> і надсилається в інститут Новою поштою разом із іншими документами, вказаними у вашому чек-листі на цьому сайті.</p>
    ...
    },
    {
        ...
        <p><strong>Важливо:</strong> на збір Вас буде викликати Ваш воєнком своїм наказом (там де Ви перебуваєте на обліку). Відповідно до законодавства України, керівник підприємства (незалежно від форми власності) зобов'язаний відрядити Вас на цей збір і зберегти за Вами середню заробітну плату на період проведення збору. Необхідно прибути з власною сезонною польовою формою одягу («піксель» ЗСУ).</p>`
    },
    {
    ...
    },
    {
        ...
        <ul>
            ...
            <li><strong>Отримувач:</strong> Приймачук Олег Віталійович</li>
        </ul>
