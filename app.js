...
const faqData = [
    {
        ...
        <ul>
            ...
            <li>Студенти закладів вищої освіти денної або заочної форми навчання (які навчаються на 2-4 курсах бакалаврату або в магістратурі);</li>
            <li>Особи, які вже мають вищу освіту ступеня не нижче бакалавра (випускники минулих років);</li>
            <li>Придатні до військової служби за станом здоров'я та морально-діловими якостями;</li>
            <li>Віком <strong>до 40 років</strong> на момент початку навчання.</li>
        </ul>`
    },
    {
        id: "faq-2",
    ...
    },
    {
        ...
        <ul>
            ...
            <li>Довідка з деканату про навчання із зазначенням середнього балу (або копія диплома для осіб з вищою освітою);</li>
            <li>Копія приписного посвідчення або військового квитка — <strong>2 примірники</strong>;</li>
            <li>Оригінал довідки ВЛК про придатність до навчання;</li>
            <li>4 матові фотокартки 3х4 см;</li>
            <li>Характеристика з місця навчання (роботи);</li>
            <li>Картонна папка-швидкозшивач та 4 прозорі файли.</li>
        </ul>
