...
const faqData = [
    ...
    },
    {
        id: "faq-5",
        category: "documents",
        question: "Які документи та копії потрібно підготувати для формування особової справи? <span style=\"font-weight: 400; font-size: 0.9em; opacity: 0.85; display: inline-block;\">(для тих, хто не є чинним військовослужбовцем)</span>",
