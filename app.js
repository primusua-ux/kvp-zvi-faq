...
const faqData = [
    ...
    },
    {
        ...
        <p>Після успішного завершення навчання випускникам видаються сертифікати <strong>L1A</strong> (базовий курс) та <strong>L1B</strong> (фаховий курс), які засвідчують отримання професійної військової освіти офіцера тактичного рівня за відповідною військово-обліковою спеціальністю.</p>`
    },
    {
