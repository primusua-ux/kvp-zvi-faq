...
const faqData = [
    ...
    },
    {
        ...
        <ul>
            ...
            <li>Оригінал довідки ВЛК про придатність до військової служби та її ксерокопія;</li>
    ...
    },
    {
        ...
        <ol>
            <li>Після повного проходження всіх етапів вступу на сайті <a href="https://sites.google.com/view/kvpzvi/" class="step-link" target="_blank" rel="noopener">sites.google.com/view/kvpzvi</a> ми надаємо вам направлення на проходження ВЛК;</li>
    ...
    },
    {
        ...
        answer: `<p><strong>Ні.</strong> Навчання на кафедрі здійснюється виключно на платній основі — за рахунок коштів фізичних чи юридичних осіб (за контрактом). Вартість навчання фіксується у договорі та може оплачуватися помісячно, по семестрах або за рік. Актуальну вартість на поточний рік уточнюйте у приймальній комісії.</p>`
    },
    {
        id: "faq-11",
        category: "education",
