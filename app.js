...
const roadmapMilitary = [
    ...
    { title: "Заява, військовий квиток, диплом", text: "Власноруч напишіть заяву на ім'я голови відбіркової комісії, сфотографуйте військовий квиток і диплом (або довідку ЄДЕБО, форма 9).", link: { href: "https://drive.google.com/file/d/15nOhUpsjAf81dUS7xF75c2ZgN5Jlo5-z/view?usp=sharing", text: "зразок заяви" } },
    { title: "Вставте всі фото в один файл .docx", text: "Назва файлу: ПІБ_дата_народження.docx (наприклад, Коваленко_Степан_Петрович_12051985.docx)." },
    { title: "Реєстрація на сайті вступу", text: "Оберіть ВОС і прикріпіть створений файл.", link: { href: "https://sites.google.com/view/kvpzvi/", text: "сайт вступу" } },
...
const checklistMilitary = [
    ...
    { id: "mil-doc-diploma", text: "Фото диплома про вищу освіту або довідки ЄДЕБО (форма 9, якщо ще навчаєтесь) - <strong>1 шт.</strong>" },
...
const faqData = [
    ...
    },
    {
        ...
        <ol>
            ...
            <li>Зробити <strong>фото диплома</strong> про вищу освіту або <strong>довідки ЄДЕБО (форма 9)</strong>, якщо ви ще навчаєтесь (бакалавр або вище);</li>
