...
const faqData = [
    ...
    },
    {
        ...
        <p>Після успішного завершення навчання випускникам видаються сертифікати <strong>L1A</strong> (базовий курс) та <strong>L1B</strong> (фаховий курс), які засвідчують отримання професійної військової освіти офіцера тактичного рівня за обраною військово-обліковою спеціальністю. Наявність цих сертифікатів засвідчує, що військовослужбовець пройшов усю необхідну підготовку для призначення на офіцерську посаду з присвоєнням відповідного військового звання.</p>`
    },
    {
