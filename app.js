...
const faqData = [
    ...
    },
    {
        ...
        <p>Теоретична частина курсу вивчається дистанційно, а практична частина, звичайно, очно.</p>
    ...
    },
    {
        ...
        answer: `<p><strong>Навчальний збір (збори)</strong> — це практичний етап навчання військової підготовки. Він триває <strong>~2 тижні</strong> і проводиться на фінальному етапі навчання.</p>
