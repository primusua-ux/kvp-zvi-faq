...
const faqData = [
    ...
    },
    {
        ...
        <p>Після успішного завершення навчання випускникам видаються сертифікати <strong>L1A</strong> (базовий курс) та <strong>L1B</strong> (фаховий курс), які засвідчують проходження підготовки офіцера тактичного рівня за відповідною військово-обліковою спеціальністю.</p>`
    },
    {
        ...
        <ol>
            ...
            <li>Відправити <strong>обидва екземпляри контракту</strong> на навчання разом із <strong>роздрукованими копіями документів</strong> (рапорт, заява, військовий квиток, диплом про вищу освіту) на відділення Нової пошти №10 у м. Житомирі (контактний телефон: <a href="tel:+380672807940">067 280 79 40</a>);</li>
    ...
    },
    {
        ...
        <p>Ви можете скористатися інтерактивним <strong>Переліком документів</strong> праворуч на цій сторінці, щоб відзначати готові довідки та роздрукувати персональний перелік.</p>`
    },
    {
        id: "faq-7",
        category: "vlk",
