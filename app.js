...
const faqData = [
    ...
    },
    {
        ...
        answer: `<p>Для формування особової справи з метою присвоєння військового звання необхідно підготувати такі документи:</p>
        <ol>
            ...
            <li>Довідка ВЛК при вступі (оригінал) — <strong>1 примірник</strong>;</li>
            <li>Контракт про навчання на військовій кафедрі — <strong>1 примірник</strong>;</li>
            <li>Ксерокопія військового облікового документу (приписне свідоцтво, військовий квиток) — <strong>1 примірник</strong>;</li>
            <li>Особиста картка — <strong>1 примірник</strong>;</li>
            <li>Індивідуальна навчальна картка — <strong>1 примірник</strong>;</li>
            ...
            <li>Довідка ВЛК перед навчальним збором (оригінал) — <strong>1 примірник</strong>;</li>
            <li>Копія Довідки ВЛК перед навчальним збором — <strong>1 примірник</strong>;</li>
            ...
            <li>Автобіографія друкована — <strong>1 примірник</strong>;</li>
    ...
    },
    {
        ...
        <ol>
            ...
            <li>Оригінал цієї довідки та її ксерокопію ви надсилаєте в інститут разом з копіями вказаних документів.</li>
        </ol>`
    },
    {
        id: "faq-8",
