...
const faqData = [
    ...
    },
    {
        ...
        answer: `<p>Бланк контракту надається разом із направленням на військово-лікарську комісію. Його необхідно заповнити зі свого боку у <strong>двох примірниках</strong> і надіслати в інститут разом із довідкою про проходження ВЛК та копіями інших документів.</p>`
    },
    {
        id: "faq-12",
        category: "oath",
