...
const faqData = [
    ...
    },
    {
        ...
        answer: `<p><strong>Ні.</strong> У разі відрахування за академічну заборгованість або добровільного припинення навчання кошти за навчання не повертаються. Ці умови передбачені контрактом на навчання, який підписується протягом місяця після наказу про зарахування.</p>`
    },
    {
        id: "faq-11",
        category: "education",
    ...
    },
    {
        ...
        answer: `<p>Кожна навчальна дисципліна передбачає певний вид звітності — залік, модульний контроль або екзамен. Незакриття цієї звітності вважається <strong>академічною заборгованістю</strong> і може бути причиною відрахування з програми підготовки офіцерів запасу.</p>
